...
*/
$config['tables']['users']           = 'tbl_pengguna';
$config['tables']['groups']          = 'tbl_grup';
$config['tables']['users_groups']    = 'tbl_grup_pengguna';
$config['tables']['login_attempts']  = 'tbl_percobaan_login';
