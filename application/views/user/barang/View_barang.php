...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li>Master Barang</li>
            <li class="active">Data Barang Ready Stock</li>
        </ol>
    </section>
...
$(document).ready(function()
{
    ...
    $('#content_data').on('click','.item-hapus',function()
    {
        ...
        var subkategori     = $(this).attr('subkategori');
        ...
        swal({
            ...
            $.ajax
                ({
                    url         : '<?php echo base_url();?>admin/barang/delete_barang',
                    type        : 'POST',
                    data        : {hapus_id:id,kategori:kategori,subkategori:subkategori,foto:foto},
    ...
    ({
            ...
            ajax            : 
            {
                url         : '<?php echo base_url();?>admin/barang/get_all_barang',
                type        : 'POST',
                dataSrc     : 'data',
            },
            fixedHeader     : true,
