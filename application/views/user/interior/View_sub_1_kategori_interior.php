...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Data Sub 1 Kategori Interior</li>
        </ol>
    </section>
                                ...
                                <table id="tabel_data" class="table table-striped table-bordered table-hover" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>ID Sub 1 Kategori Interior</th>
                                            <th>Nama Sub 1 Kategori Interior</th>
                                            <th>Jumlah Barang Terinput Pada Sub 1 Kategori Interior Ini</th>
...
$(document).ready(function()
{
    $('#content_data').on('click','.item-edit',function()
    {
        ...
        $.ajax
        ({
            url         : '<?php echo base_url();?>admin/interior/get_sub_1_kategori_interior_by_id',
            type        : 'POST',
            data        : {id_sub_kategori:id},
            dataType    : 'JSON',
            success     : function(data)
            {
                $('#edit_id').val(data.sub_1_kategori_interior_id);
                $('#edit_nama').val(data.sub_1_kategori_interior_nama)
    ...
    $('#tambah_submit').submit(function(e)
    {
        ...
        $.ajax
        ({
            url         : '<?php echo base_url();?>admin/interior/set_sub_1_kategori_interior',
            type        : 'POST',
    ...
    $('#edit_submit').submit(function(e)
    {
        ...
        $.ajax
        ({
            url         : '<?php echo base_url();?>admin/interior/update_sub_1_kategori_interior',
            type        : 'POST',
            data        : new FormData(this),
            processData : false,
            contentType : false,
    ...
    $('#content_data').on('click','.item-hapus',function()
    {
        ...
        swal({
            ...
            $.ajax
                ({
                    url         : '<?php echo base_url();?>admin/interior/delete_sub_1_kategori_interior',
                    type        : 'POST',
                    data        : {hapus_id:id},
                    success     : function(data)
                    {
    ...
    ({
            ...
            ajax            : 
            {
                url         : '<?php echo base_url();?>admin/interior/get_all_sub_1_kategori_interior',
                type        : 'POST',
                dataSrc     : 'data',
            },
            fixedHeader     : true,
