...
<div class="content-wrapper">
    ...
    <section class="content container-fluid">
        <form action="<?php echo base_url().'admin/barang/update_barang'?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="edit_subkategori" id="edit_subkategori" style="width: 100%;" required>
    ...
    function tampil_data()
    {
    	...
    	({
    		...
    		success 	: function(data)
    		{
    			...
    			$('#edit_subkategori').val(data.sub_kategori_id).trigger('change');
    			$('#edit_subkategori_old').val(data.sub_kategori_id);
    		}
    	})
    }
