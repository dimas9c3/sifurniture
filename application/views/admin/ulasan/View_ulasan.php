...
$(document).ready(function()
{
    ...
    $('#content_data').on('click','.item-tampil',function()
    {
        var id              = $(this).attr('data');
        swal({
            title: "Apakah anda yakin akan menampilkan ulasan ini ke beranda?",
            type: "warning",
            showCancelButton: true,
            confirmButtonColor: "#DD6B55",
            confirmButtonText: "Ya",
            ...
            $.ajax
                ({
                    url         : '<?php echo base_url();?>admin/ulasan/set_tampil',
                    type        : 'POST',
                    data        : {id_ulasan:id},
                    success     : function(data)
                    {
    ...
    ({
            ...
            ajax            : 
            {
                url         : '<?php echo base_url();?>admin/ulasan/get_all_ulasan',
                type        : 'POST',
                dataSrc     : 'data',
            },
            fixedHeader     : true,
