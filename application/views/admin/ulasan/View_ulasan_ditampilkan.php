...
$(document).ready(function()
{
    ...
    $('#content_data').on('click','.item-hapus',function()
    {
        ...
        swal({
            ...
            $.ajax
                ({
                    url         : '<?php echo base_url();?>admin/ulasan/delete_ulasan',
                    type        : 'POST',
                    data        : {hapus_id:id},
    ...
    $('#content_data').on('click','.item-tampil',function()
    {
        var id              = $(this).attr('data');
        swal({
            title: "Apakah anda yakin akan menyembunyikan ulasan ini dari beranda?",
            type: "warning",
            showCancelButton: true,
            confirmButtonColor: "#DD6B55",
            confirmButtonText: "Ya",
            ...
            $.ajax
                ({
                    url         : '<?php echo base_url();?>admin/ulasan/set_sembunyi',
                    type        : 'POST',
                    data        : {id_ulasan:id},
                    success     : function(data)
                    {
                        ...
                        {
                            title       : "Yay!",
                            text        : "Data Berhasil Ditampilkan Ke Beranda",
                            type        : "success",
                            timer       : 1000,
                            showConfirmButton : false
                        });
    ...
    ({
            ...
            ajax            : 
            {
                url         : '<?php echo base_url();?>admin/ulasan/get_ulasan_ditampilkan',
                type        : 'POST',
                dataSrc     : 'data',
            },
            fixedHeader     : true,
