...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Edit Data Artikel</li>
        </ol>
    </section>
            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <input type="text" name="tambah_nama" id="tambah_nama" class="form-control" value="" required/>
                    </div>
                    <!-- /.col -->
                </div>
            </div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="image-upload">
                                <input type="file" name="tambah_foto" multiple class="form-control"><br>
                            </div>
                        </div>
                    </div>
                    <!-- /.box-body -->
...
$(document).ready(function()
{
    ...
    function get_data()
    {
        ...
        $.ajax
        ({
            url             : '<?php echo base_url().'admin/artikel/get_artikel_by_id'; ?>',
            type            : 'POST',
            data            : {id_artikel:uri},
            dataType        : 'JSON',
            success         : function(data)
            {
                $('#tambah_nama').val(data.artikel_judul);
                $('#ckeditor').val(data.artikel_isi);
                $('#id_artikel').val(data.artikel_id);
            }
        })
    }
