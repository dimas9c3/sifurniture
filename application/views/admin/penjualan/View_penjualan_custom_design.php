...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Data Penjualan Custom Design</li>
        </ol>
    </section>
...
$(document).ready(function()
{
    ...
    $('#content_data').on('click','.item-batal',function()
    {
        var id      = $(this).attr('data');
        swal({
            title: "Apakah anda yakin akan membatalkan transaksi ?",
            type: "warning",
            ...
            $.ajax
                ({
                    url         : '<?php echo base_url();?>admin/penjualan/batal_custom_design',
                    type        : 'POST',
                    data        : {id_penjualan:id},
                    success     : function(data)
                    {
    ...
    $('#content_data').on('click','.item-selesai',function()
    {
        var id      = $(this).attr('data');
        swal({
            title: "Apakah anda yakin akan transaksi selesai ?",
            type: "warning",
            showCancelButton: true,
            confirmButtonColor: "#DD6B55",
            confirmButtonText: "Ya",
            ...
            $.ajax
                ({
                    url         : '<?php echo base_url();?>admin/penjualan/selesai_custom_design',
                    type        : 'POST',
                    data        : {id_penjualan:id},
                    success     : function(data)
                    {
    ...
    ({
            ...
            ajax            : 
            {
                url         : '<?php echo base_url();?>admin/penjualan/get_penjualan_custom_design_active',
                type        : 'POST',
                dataSrc     : 'data',
            },
            fixedHeader     : true,
