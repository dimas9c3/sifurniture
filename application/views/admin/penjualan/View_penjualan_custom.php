...
$(document).ready(function()
{
    ...
    $('#content_data').on('click','.item-batal',function()
    {
        ...
        swal({
            ...
            $.ajax
                ({
                    url         : '<?php echo base_url();?>admin/penjualan/batal_pembelian_custom',
                    type        : 'POST',
                    data        : {id_penjualan:id},
                    success     : function(data)
                    {
    ...
    $('#content_data').on('click','.item-valid',function()
    {
        var id      = $(this).attr('data');
        swal({
            title: "Apakah anda yakin transaksi sudah valid?",
            type: "warning",
            showCancelButton: true,
            confirmButtonColor: "#DD6B55",
            confirmButtonText: "Ya",
            ...
            $.ajax
                ({
                    url         : '<?php echo base_url();?>admin/penjualan/validasi_penjualan_custom',
                    type        : 'POST',
                    data        : {id_penjualan:id},
                    success     : function(data)
                    {
    ...
    ({
            ...
            ajax            : 
            {
                url         : '<?php echo base_url();?>admin/penjualan/get_penjualan_custom_active',
                type        : 'POST',
                dataSrc     : 'data',
            },
            fixedHeader     : true,
