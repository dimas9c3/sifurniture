...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li>Master Barang</li>
            <li class="active">Data Sub Kategori Barang</li>
        </ol>
    </section>
...
$(document).ready(function()
{
    ...
    $('#content_data').on('click','.item-edit',function()
    {
        ...
        $.ajax
        ({
            url         : '<?php echo base_url();?>admin/barang/get_sub_kategori_by_id',
            type        : 'POST',
            data        : {id_sub_kategori:id},
            dataType    : 'JSON',
            success     : function(data)
            {
                $('#edit_id').val(data.sub_kategori_id);
                $('#edit_kategori').val(data.kategori_id).trigger('change');
                $('#edit_nama').val(data.sub_kategori_nama)
    ...
    $('#tambah_submit').submit(function(e)
    {
        ...
        $.ajax
        ({
            url         : '<?php echo base_url();?>admin/barang/set_sub_kategori',
            type        : 'POST',
    ...
    $('#edit_submit').submit(function(e)
    {
        ...
        $.ajax
        ({
            url         : '<?php echo base_url();?>admin/barang/update_sub_kategori',
            type        : 'POST',
            data        : new FormData(this),
            processData : false,
            contentType : false,
    ...
    $('#content_data').on('click','.item-hapus',function()
    {
        ...
        swal({
            ...
            $.ajax
                ({
                    url         : '<?php echo base_url();?>admin/barang/delete_sub_kategori',
                    type        : 'POST',
                    data        : {hapus_id:id},
                    success     : function(data)
                    {
    ...
    ({
            ...
            ajax            : 
            {
                url         : '<?php echo base_url();?>admin/barang/get_all_sub_kategori',
                type        : 'POST',
                dataSrc     : 'data',
            },
            fixedHeader     : true,
